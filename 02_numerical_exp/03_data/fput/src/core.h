...
// PUBLIC    
    ...
    const Matrix<double,9, 1> & x() const;
    const Matrix<double,9, 1> & dx() const;
    const Matrix<double,0, 0> & w() const;
    const Matrix<double,0, 0> & u() const;
    const Matrix<double,0, 0> & p() const;
    const Matrix<double,9, 1> & vnl() const;
    const Matrix<double,6, 1> & o() const;
    //==========================================================================
    ...
    void set_x(const Matrix<double, 9, 1> &);
    void set_dx(const Matrix<double, 9, 1> &);
    void set_w(const Matrix<double, 0, 0> &);
    void set_u(const Matrix<double, 0, 0> &);
    void set_p(const Matrix<double, 0, 0> &);
    void set_vnl(const Matrix<double, 9, 1> &);
    void set_o(const Matrix<double, 6, 1> &);
    //==========================================================================
    ...
    const Matrix<double,6, 1> & ud_o() const;
    const Matrix<double,9, 1> & Gnl() const;
    const Matrix<double,9, 9> & jacGnlnl() const;
    const Matrix<double,9, 1> & dxH() const;
    ...
    const Matrix<double,9, 1> & ud_x() const;
    const Matrix<double,9, 1> & Fnl() const;
    const Matrix<double,9, 9> & jacFnl() const;
    const Matrix<double,9, 9> & ijacFnl() const;
    const Matrix<double,9, 1> & save_Fnl() const;
    const double & res_Fnl() const;
    const double & step_Fnl() const;
    const Matrix<double,9, 1> & ud_vnl() const;
    //==========================================================================
    // Oprations Results Accessors
...
// PRIVATE    
    ...
    const double * m_R1 = & subs[indexParameters][4];
    const double * m_R2 = & subs[indexParameters][5];
    const double * m_R3 = & subs[indexParameters][6];
    const double * m_R4 = & subs[indexParameters][7];
    const double * k_1 = & subs[indexParameters][8];
    const double * k_2 = & subs[indexParameters][9];
    const double * k_3 = & subs[indexParameters][10];
    const double * k_4 = & subs[indexParameters][11];
    //==========================================================================
    // Arguments
    Matrix<double,24, 1> args;
    double * Pi_L1 = & args(0, 0);
    double * Pi_12 = & args(1, 0);
    double * Pi_23 = & args(2, 0);
    double * Pi_34 = & args(3, 0);
    double * Pi_R4 = & args(4, 0);
    double * x_k1 = & args(5, 0);
    double * x_k2 = & args(6, 0);
    double * x_k3 = & args(7, 0);
    double * x_k4 = & args(8, 0);
    double * dPi_L1 = & args(9, 0);
    double * dPi_12 = & args(10, 0);
    double * dPi_23 = & args(11, 0);
    double * dPi_34 = & args(12, 0);
    double * dPi_R4 = & args(13, 0);
    double * dx_k1 = & args(14, 0);
    double * dx_k2 = & args(15, 0);
    double * dx_k3 = & args(16, 0);
    double * dx_k4 = & args(17, 0);
    double * RHS_1 = & args(18, 0);
    double * RHS_2 = & args(19, 0);
    double * RHS_3 = & args(20, 0);
    double * Delta_12 = & args(21, 0);
    double * Delta_23 = & args(22, 0);
    double * Delta_34 = & args(23, 0);
    //==========================================================================
    // Functions Results Definitions
    Matrix<double,6, 1> _ud_o;
    Matrix<double,9, 1> _Gnl;
    Matrix<double,9, 9> _jacGnlnl;
    Matrix<double,9, 1> _dxH;
    ...
    Matrix<double,9, 1> _ud_x;
    Matrix<double,9, 1> _Fnl;
    Matrix<double,9, 9> _jacFnl;
    Matrix<double,9, 9> _ijacFnl;
    Matrix<double,9, 1> _save_Fnl;
    double _res_Fnl;
    double _step_Fnl;
    Matrix<double,9, 1> _ud_vnl;
    //==========================================================================
